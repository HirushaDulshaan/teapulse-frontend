...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-[#0A0F0D] text-[#E8E4D6]">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-20 sm:pb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <SectionCard
            ...
            title="GPS Estate Mapping"
            tagline="Locate every division with satellite-accurate boundaries."
          ...
          <SectionCard
            ...
            title="Variable Rate Calculations"
            tagline="Urea, TSP and MOP ratios tuned to pH and slope."
          ...
          <SectionCard
            ...
            tagline="See block health change season over season."
            gradient="from-[#0E4A33] to-[#0A0F0D]"
            Icon={Satellite}
          />
          <SectionCard
            href="/dashboard/analytics"
            title="Cost vs Yield Analytics"
            tagline="Blanket application versus precision, in real LKR."
          ...
          <SectionCard
            ...
            tagline="Upload tea leaf or stem photos to instantly detect diseases, pest attacks, and get treatment guidelines."
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-[#050B08] text-[#8A8677] py-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-center sm:text-right">
            TeaPulse AI Precision Engine &bull; Built for Cresco Origin Challenge 2026
          </p>
        </div>
      </footer>
    </div>
