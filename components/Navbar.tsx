    ...
    <nav className="fixed top-4 left-4 right-4 z-50">
      <div className="max-w-7xl mx-auto bg-[#0A0F0D]/90 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-3.5 flex items-center justify-between shadow-lg shadow-black/30">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#D6D3C4] absolute left-1/2 -translate-x-1/2">
          <Link href="/dashboard/mapping" className="hover:text-white transition">
            Mapping
          </Link>
          <Link href="/dashboard/variable-rate" className="hover:text-white transition">
            Variable Rate
          </Link>
          <Link href="/dashboard/satellite" className="hover:text-white transition">
            Satellite
          </Link>
          <Link href="/articles" className="hover:text-white transition flex items-center gap-2">
  <BookOpen className="w-4 h-4" /> Articles
</Link>
          <Link href="/ai-support" className="text-[#00E68A] hover:text-[#00E68A]/80 transition">
            AI Agronomy
          </Link>
        </div>
